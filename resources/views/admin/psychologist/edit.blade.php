        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Edit Psikolog</a></div>
                </div>
            </div>

            <div class="section-body">
                <h2 class="section-title">Form Edit Psikolog</h2>
                <p class="section-lead">Anda dapat mengisi form di bawah ini untuk mengedit Psikolog</p>

                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Form Edit Psikolog</h4>
                            </div>
                            <div class="card-body">
                                @if($errors->any())
                                ...
                                @endif
                                <form action="{{ route('admin.psychologists.update', $datum->id) }}" method="post" enctype="multipart/form-data">
                                    {{ method_field('PUT') }}
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <textarea name="description" class="summernote-simple"
                                                required>{{ $datum->description }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <div id="image-preview" class="image-preview" style="background-size: cover;
                                            background-position: center center; background-image: url({{ $datum->ImagePath }})">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            ...
                                            <a href="{{ route('admin.psychologists.index') }}" class="ml-3 btn btn-secondary">Batal</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
